...
#  python prepare_dataset.py --dataset pascal --year 2007 --set trainval --target ./../data/train.lst
								   
# python prepare_dataset.py --dataset pascal --year 2007 --set test --target ./../data/val.lst --no-shuffle								 